...
type ReEncryptDeviceQueueItemsRequest struct {
	...
	// Items to re-encrypt.
	Items                *ReEncryptDeviceQueueItem `protobuf:"bytes,4,opt,name=items,proto3" json:"items,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
type ReEncryptDeviceQueueItemsResponse struct {
	Items                *ReEncryptedDeviceQueueItem `protobuf:"bytes,1,opt,name=items,proto3" json:"items,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
var fileDescriptor_1d6d0f577a60e27d = []byte{
	...
	,
}
